...
const allTests = [
    { id: 1, name: 'صورة الدم كاملة (CBC)', category: 'أمراض الدم', price: '70 ر.س' },
    { id: 2, name: 'فيتامين د (Vitamin D)', category: 'فيتامينات', price: '150 ر.س' },
    { id: 3, name: 'فحص السكر التراكمي (HbA1c)', category: 'الكيمياء الحيوية', price: '60 ر.س' },
    { id: 4, name: 'وظائف الكبد الشاملة (Liver Profile)', category: 'الكيمياء الحيوية', price: '120 ر.س' },
    { id: 5, name: 'وظائف الكلى (Renal Profile)', category: 'الكيمياء الحيوية', price: '90 ر.س' },
    { id: 6, name: 'الغدة الدرقية (TSH)', category: 'هرمونات', price: '80 ر.س' },
    { id: 7, name: 'فحص الحديد (Iron Profile)', category: 'أمراض الدم', price: '140 ر.س' },
    { id: 8, name: 'تحليل البول (Urine Analysis)', category: 'ميكروبيولوجي', price: '40 ر.س' },
    { id: 9, name: 'فيتامين ب12 (Vitamin B12)', category: 'فيتامينات', price: '130 ر.س' },
    { id: 10, name: 'فحص الدهون (Lipid Profile)', category: 'الكيمياء الحيوية', price: '110 ر.س' },
];
